...
export default function KerenRightlerCaseStudy() {
  ...
  const t = locales[lang].caseKerenRightler
  const isRTL = lang === 'he'
    ...
    <main className="cs" dir={isRTL ? 'rtl' : 'ltr'} lang={lang}>
      ...
      <header className="cs-hero">
        <div className="cs-wrap">
          ...
          <a className="cs-cta-link" href="https://www.redigma.com/project/keren-rightler/" target="_blank" rel="noopener noreferrer">
            {t.viewLive}
          </a>

          <div className="cs-cover">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/keren-rightler/cover.jpg" alt={t.coverAlt} />
          </div>
        </div>
      </header>
